...
tetris:
	...
	@$(COMPILER) $(CFLAGS) bin/init.o bin/draw.o bin/input.o bin/draw_scene.o bin/draw_piece.o bin/position.o bin/process_state.o bin/check_movement.o bin/draw_dead_blocks.o bin/main.o -o tetris